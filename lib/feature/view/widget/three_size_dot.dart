        ...
        ScaleTransition(
          ...
          child: Padding(
            ...
            child: Dot(
              shape: widget.shape,
              size: widget.size,
              color: widget.color_1 ?? Theme.of(context).backgroundColor,
            ),
          ),
        ),
        ScaleTransition(
          ...
          child: Padding(
            ...
            child: Dot(
              shape: widget.shape,
              size: widget.size,
              color: widget.color_2 ?? Theme.of(context).backgroundColor,
            ),
          ),
        ),
        ScaleTransition(
          ...
          child: Padding(
            ...
            child: Dot(
              shape: widget.shape,
              size: widget.size,
              color: widget.color_3 ?? Theme.of(context).backgroundColor,
            ),
          ),
        ),
      ],
